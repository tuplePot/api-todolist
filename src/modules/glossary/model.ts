...
import type { ConfidenceLevel, IGlossaryEntry } from "./types";

const confidenceEnum = t.Union([
	t.Literal("new"),
	t.Literal("learning"),
	t.Literal("known"),
]);
...
export const glossaryQuery = t.Object({
	...
	confidence: t.Optional(confidenceEnum),
	sort: t.Optional(
		t.Union([t.Literal("az"), t.Literal("newest"), t.Literal("oldest")]),
	),
...
export const GlossaryEntry = mongoose.model<IGlossaryEntry>(
	"GlossaryEntry",
	GlossaryEntrySchema,
);
